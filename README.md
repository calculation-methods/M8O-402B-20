...
Темы курсовой работы студенты выбирают самостоятельно и добавляют их в таблицу ниже отдельным запросом (см. [порядок сдачи](#порядок-сдачи)).
